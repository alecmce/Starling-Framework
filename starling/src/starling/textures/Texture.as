...
package starling.textures
{
	...
	public class Texture
	{
		...
		public static function fromBitmap(data:Bitmap, generateMipMaps:Boolean = true, optimizeForRenderTexture:Boolean = false):starling.textures.Texture
		{
			return fromBitmapData(data.bitmapData, generateMipMaps, optimizeForRenderTexture);
		}

		/** Creates a texture from bitmap data. */
		public static function fromBitmapData(data:BitmapData, generateMipMaps:Boolean = true, optimizeForRenderTexture:Boolean = false):starling.textures.Texture
		{
			...
			var nativeTexture:flash.display3D.textures.Texture = Starling.context.createTexture(legalWidth, legalHeight, format, optimizeForRenderTexture);
			...
			var concreteTexture:starling.textures.Texture = new ConcreteTexture(nativeTexture, legalWidth, legalHeight, generateMipMaps, true);
		...
		public static function fromAtfData(data:ByteArray):starling.textures.Texture
		{
			...
			var nativeTexture:flash.display3D.textures.Texture = Starling.context.createTexture(width, height, format, false);
		...
		public static function fromTexture(texture:starling.textures.Texture, region:Rectangle):starling.textures.Texture
		{
		...
		public static function empty(width:int = 64, height:int = 64, color:uint = 0xffffffff, optimizeForRenderTexture:Boolean = false):starling.textures.Texture
		{
			var bitmapData:BitmapData = new BitmapData(width, height, true, color);
			var texture:starling.textures.Texture = fromBitmapData(bitmapData, false, optimizeForRenderTexture);
			bitmapData.dispose();
			return texture;
		}
		...
		private static function uploadTexture(data:BitmapData, texture:flash.display3D.textures.Texture, generateMipmaps:Boolean):void
		{
